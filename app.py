...
def clean_phone_for_whatsapp(phone_raw):
    ...
    # 2. 如果包含多个号码（逗号/分号/换行分隔），取第一个
    # 例如: "8 800 100-01-55, +7 (4942) 62-01-31" -> 取 "8 800 100-01-55"
    s_first = re.split(r'[;,\n]', s_raw)[0]
    
    # 3. 去掉小数点 (处理 Excel 浮点数)
    s = s_first.split('.')[0].strip()
